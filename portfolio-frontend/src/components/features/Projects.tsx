...
export default function Projects({ projects, showStats = true, limit, statVisibility, sectionLabel, sectionTitle, sectionTitleAccent, sectionSubtitle, sectionId = 'projects', altBg = false }: ProjectsProps) {
  ...
  return (
    <section id={sectionId} className="py-20 md:py-32 relative overflow-hidden" style={altBg ? { background: 'var(--section-alt-bg)' } : undefined}>
      {/* Background Pattern */}
