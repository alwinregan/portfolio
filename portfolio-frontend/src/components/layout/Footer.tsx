...
export default function Footer({ profileName }: FooterProps) {
  ...
  const brandIcons = [
    profileGithub && {
      href: profileGithub, label: 'GitHub', svg: (
    ...
    profileLinkedin && {
      href: profileLinkedin, label: 'LinkedIn', svg: (
        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
    ...
    profileEmail && {
      href: `mailto:${profileEmail}`, label: 'Email', svg: (
