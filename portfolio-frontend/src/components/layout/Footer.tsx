...
export default function Footer({ profileName }: FooterProps) {
  const name = profileName || 'Alwin Regan P';
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              {[
                { href: 'https://github.com/alwinregan', label: 'GitHub', svg: (
                ...
                { href: 'https://linkedin.com/in/alwinregan', label: 'LinkedIn', svg: (
                  <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                )},
                { href: 'mailto:alwinregancse98@gmail.com', label: 'Email', svg: (
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:alwinregancse98@gmail.com"
                  className="flex items-center gap-3 text-sm font-medium text-muted hover:text-foreground transition-colors group">
                  <span className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-colors group-hover:text-white"
                    style={{ background: 'rgba(var(--color-primary),0.10)', border: '1px solid rgba(var(--color-primary),0.20)' }}>
                    <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                    </svg>
                  </span>
                  alwinregancse98@gmail.com
                </a>
              </li>
              <li>
